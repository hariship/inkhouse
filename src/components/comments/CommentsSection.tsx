    ...
    <div className="mt-12 border-t border-[var(--color-border-light)] pt-8">
      ...
      <form onSubmit={(e) => handleSubmit(e)} className="mb-8">
          ...
          <div className="mb-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <input
                ...
                required
                className="px-4 py-2 border border-[var(--color-border-medium)] rounded-md text-[var(--color-text-primary)] bg-[var(--color-bg-card)] focus:ring-1 focus:ring-[var(--color-link)] focus:border-[var(--color-link)] focus:outline-none"
              />
              <input
                type="email"
        ...
        <textarea
          ...
          rows={3}
          required
          className="w-full px-4 py-2 border border-[var(--color-border-medium)] rounded-md text-[var(--color-text-primary)] bg-[var(--color-bg-card)] mb-4 focus:ring-1 focus:ring-[var(--color-link)] focus:border-[var(--color-link)] focus:outline-none"
        />
        <button
          type="submit"
