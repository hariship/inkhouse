...
import { Lightbulb, Plus, X, Trash2, Check, Ban } from 'lucide-react'
    ...
    return (
      <div>
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6 sm:mb-8">
          ...
          <div className="h-10 w-36 bg-[var(--color-bg-tertiary)] rounded-md animate-pulse" />
        </div>
              ...
              <div className="flex gap-4">
                ...
                <div className="flex-1 space-y-3">
                  ...
                  <div className="flex gap-3">
                    <div className="h-3 w-14 bg-[var(--color-bg-tertiary)] rounded animate-pulse" />
                    <div className="h-3 w-16 bg-[var(--color-bg-tertiary)] rounded animate-pulse" />
                    <div className="h-3 w-20 bg-[var(--color-bg-tertiary)] rounded animate-pulse" />
                  </div>
                </div>
              </div>
            </div>
    ...
    <div>
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6 sm:mb-8">
        <div>
          ...
          <p className="text-sm sm:text-base text-[var(--color-text-secondary)]">
            Vote on ideas to improve Inkhouse ({threshold} votes needed for 50%)
          </p>
        </div>
        <button
            ...
            return (
              ...
              >
                ...
                <div className="flex gap-3 sm:gap-4">
                  ...
                  {/* Actions - right side (stop propagation to prevent card click) */}
